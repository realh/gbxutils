...
export class GbxHeader extends GbxObject {
    ...
    parseUserData(p, userDataSize) {
        ...
        this.template.push(["headerChunks", "array", GbxChunk,
                this.numHeaderChunks]);
        this.headerChunks = [];
        let dataSize = 0;
        ...
        for (let i = 0; i < this.headerChunks.length; ++i) {
            ...
            */
            e = this.headerChunks[i] = GbxChunk.make(e.chunkID, e.chunkSize);
            e.parseBinary(p);
    ...
    toBin(b) {
        ...
        if (this.numHeaderChunks) {
            ...
            for (const c of this.headerChunks) {
                ...
                //console.log("Resetting lookbackstrings after header chunk");
    ...
    tm2ToNF() {
        for (let i = 0; i < this.numHeaderChunks; ++i) {
            ...
            if (chunk.chunkID == 0x3043008) {
                ...
                // 8 for the id and size fields
                this.sizeChange -= chunk.chunkSize.size() + 8;
