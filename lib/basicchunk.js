...
// See also: makehunkSubClass
export function makeGbxSubclass(name, template, parser) {
...
makeChunkSubclass("ChallengeParameters06", 0x0305b006, [], function(p)
{
    ...
    this.addTemplateAndValue(p, "items", "array", "uint32", this.numItems);
});
...
makeChunkSubclass("MediaTrack04", 0x03079004,
        [["keepPlaying", "bool"], ["ignored", "uint32"]]);
